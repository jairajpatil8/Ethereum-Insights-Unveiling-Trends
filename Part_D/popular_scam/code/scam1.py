...
: python scam1.py -r hadoop --output-dir scam_part_1 --no-cat-output hdfs://andromeda.eecs.qmul.ac.uk/data/ethereum/transactions/ hdfs://andromeda.eecs.qmul.ac.uk/data/ethereum/scams.json/