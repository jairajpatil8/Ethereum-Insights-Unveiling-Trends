...
python scam2.py -r hadoop --output-dir scam_part_2 --no-cat-output hdfs://andromeda.eecs.qmul.ac.uk/data/ethereum/transactions/ hdfs://andromeda.eecs.qmul.ac.uk/data/ethereum/scams.json/